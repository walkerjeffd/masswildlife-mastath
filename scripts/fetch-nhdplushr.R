...
nhdwaterbody <- st_make_valid(nhdplusTools::get_nhdplushr(download_dir, layers = "NHDWaterbody")$NHDWaterbody)
...
nhdwaterbody_ma <- st_filter(nhdwaterbody, st_transform(gis_state, crs = st_crs(nhdwaterbody)))
...
st_write(st_cast(nhdwaterbody_ma, "MULTIPOLYGON"), file.path(gis_dir, "nhdwaterbody.shp"))
